...
Take a look at our [Reference section](../reference/index.md) when you need to know design decisions, what functions the API supports, detailed developer guides, etc.

Finally, for a better understanding of Kubeapps architecture, our [Background section](../background/index.md) enables you to expand your knowledge.
