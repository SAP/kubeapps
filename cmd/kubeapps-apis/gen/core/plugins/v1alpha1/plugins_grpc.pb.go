...
const (
	PluginsService_GetConfiguredPlugins_FullMethodName = "/kubeappsapis.core.plugins.v1alpha1.PluginsService/GetConfiguredPlugins"
)
...
func (c *pluginsServiceClient) GetConfiguredPlugins(ctx context.Context, in *GetConfiguredPluginsRequest, opts ...grpc.CallOption) (*GetConfiguredPluginsResponse, error) {
	...
	err := c.cc.Invoke(ctx, PluginsService_GetConfiguredPlugins_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPluginsServiceServer should be embedded to have
...
func (UnimplementedPluginsServiceServer) GetConfiguredPlugins(context.Context, *GetConfiguredPluginsRequest) (*GetConfiguredPluginsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetConfiguredPlugins not implemented")
}
...
func RegisterPluginsServiceServer(s grpc.ServiceRegistrar, srv PluginsServiceServer) {
	// If the following call panics, it indicates UnimplementedPluginsServiceServer was
...
func _PluginsService_GetConfiguredPlugins_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PluginsService_GetConfiguredPlugins_FullMethodName,
	}
