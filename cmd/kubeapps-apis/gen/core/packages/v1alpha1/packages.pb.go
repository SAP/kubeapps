...
type AvailablePackageDetail struct {
	...
	AdditionalDefaultValues map[string]string `protobuf:"bytes,17,rep,name=additional_default_values,json=additionalDefaultValues,proto3" json:"additional_default_values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDesc = "" +
	"\n" +
	"2kubeappsapis/core/packages/v1alpha1/packages.proto\x12#kubeappsapis.core.packages.v1alpha1\x1a\x1cgoogle/api/annotations.proto\x1a\x19google/protobuf/any.proto\x1a0kubeappsapis/core/plugins/v1alpha1/plugins.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xaf\x02\n" +
	"#GetAvailablePackageSummariesRequest\x12F\n" +
	"\acontext\x18\x01 \x01(\v2,.kubeappsapis.core.packages.v1alpha1.ContextR\acontext\x12Y\n" +
	"\x0efilter_options\x18\x02 \x01(\v22.kubeappsapis.core.packages.v1alpha1.FilterOptionsR\rfilterOptions\x12e\n" +
	"\x12pagination_options\x18\x03 \x01(\v26.kubeappsapis.core.packages.v1alpha1.PaginationOptionsR\x11paginationOptions\"\xb7\x01\n" +
	" GetAvailablePackageDetailRequest\x12r\n" +
	"\x15available_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12\x1f\n" +
	"\vpkg_version\x18\x02 \x01(\tR\n" +
	"pkgVersion\"\xb9\x01\n" +
	"\"GetAvailablePackageVersionsRequest\x12r\n" +
	"\x15available_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12\x1f\n" +
	"\vpkg_version\x18\x02 \x01(\tR\n" +
	"pkgVersion\"\xba\x01\n" +
	"#GetAvailablePackageMetadatasRequest\x12r\n" +
	"\x15available_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12\x1f\n" +
	"\vpkg_version\x18\x02 \x01(\tR\n" +
	"pkgVersion\"\xd4\x01\n" +
	"#GetInstalledPackageSummariesRequest\x12F\n" +
	"\acontext\x18\x01 \x01(\v2,.kubeappsapis.core.packages.v1alpha1.ContextR\acontext\x12e\n" +
	"\x12pagination_options\x18\x02 \x01(\v26.kubeappsapis.core.packages.v1alpha1.PaginationOptionsR\x11paginationOptions\"\x96\x01\n" +
	" GetInstalledPackageDetailRequest\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\"\xf2\x03\n" +
	"\x1dCreateInstalledPackageRequest\x12r\n" +
	"\x15available_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12S\n" +
	"\x0etarget_context\x18\x02 \x01(\v2,.kubeappsapis.core.packages.v1alpha1.ContextR\rtargetContext\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12i\n" +
	"\x15pkg_version_reference\x18\x04 \x01(\v25.kubeappsapis.core.packages.v1alpha1.VersionReferenceR\x13pkgVersionReference\x12\x16\n" +
	"\x06values\x18\x05 \x01(\tR\x06values\x12q\n" +
	"\x16reconciliation_options\x18\x06 \x01(\v2:.kubeappsapis.core.packages.v1alpha1.ReconciliationOptionsR\x15reconciliationOptions\"\x89\x03\n" +
	"\x1dUpdateInstalledPackageRequest\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\x12i\n" +
	"\x15pkg_version_reference\x18\x02 \x01(\v25.kubeappsapis.core.packages.v1alpha1.VersionReferenceR\x13pkgVersionReference\x12\x16\n" +
	"\x06values\x18\x03 \x01(\tR\x06values\x12q\n" +
	"\x16reconciliation_options\x18\x04 \x01(\v2:.kubeappsapis.core.packages.v1alpha1.ReconciliationOptionsR\x15reconciliationOptions\"\x93\x01\n" +
	"\x1dDeleteInstalledPackageRequest\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\"\x9c\x01\n" +
	"&GetInstalledPackageResourceRefsRequest\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\"\xec\x01\n" +
	"$GetAvailablePackageSummariesResponse\x12|\n" +
	"\x1bavailable_package_summaries\x18\x01 \x03(\v2<.kubeappsapis.core.packages.v1alpha1.AvailablePackageSummaryR\x19availablePackageSummaries\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1e\n" +
	"\n" +
	"categories\x18\x03 \x03(\tR\n" +
	"categories\"\x9a\x01\n" +
	"!GetAvailablePackageDetailResponse\x12u\n" +
	"\x18available_package_detail\x18\x01 \x01(\v2;.kubeappsapis.core.packages.v1alpha1.AvailablePackageDetailR\x16availablePackageDetail\"\x8f\x01\n" +
	"#GetAvailablePackageVersionsResponse\x12h\n" +
	"\x14package_app_versions\x18\x01 \x03(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\x12packageAppVersions\"\xfb\x01\n" +
	"$GetAvailablePackageMetadatasResponse\x12r\n" +
	"\x15available_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12_\n" +
	"\x10package_metadata\x18\x02 \x03(\v24.kubeappsapis.core.packages.v1alpha1.PackageMetadataR\x0fpackageMetadata\"\xcc\x01\n" +
	"$GetInstalledPackageSummariesResponse\x12|\n" +
	"\x1binstalled_package_summaries\x18\x01 \x03(\v2<.kubeappsapis.core.packages.v1alpha1.InstalledPackageSummaryR\x19installedPackageSummaries\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\x9a\x01\n" +
	"!GetInstalledPackageDetailResponse\x12u\n" +
	"\x18installed_package_detail\x18\x01 \x01(\v2;.kubeappsapis.core.packages.v1alpha1.InstalledPackageDetailR\x16installedPackageDetail\"\x94\x01\n" +
	"\x1eCreateInstalledPackageResponse\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\"\x94\x01\n" +
	"\x1eUpdateInstalledPackageResponse\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\" \n" +
	"\x1eDeleteInstalledPackageResponse\"\xc8\x01\n" +
	"'GetInstalledPackageResourceRefsResponse\x12F\n" +
	"\acontext\x18\x01 \x01(\v2,.kubeappsapis.core.packages.v1alpha1.ContextR\acontext\x12U\n" +
	"\rresource_refs\x18\x02 \x03(\v20.kubeappsapis.core.packages.v1alpha1.ResourceRefR\fresourceRefs\"\x8b\x03\n" +
	"\x17AvailablePackageSummary\x12r\n" +
	"\x15available_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12]\n" +
	"\x0elatest_version\x18\x03 \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\rlatestVersion\x12\x19\n" +
	"\bicon_url\x18\x04 \x01(\tR\aiconUrl\x12!\n" +
	"\fdisplay_name\x18\x05 \x01(\tR\vdisplayName\x12+\n" +
	"\x11short_description\x18\x06 \x01(\tR\x10shortDescription\x12\x1e\n" +
	"\n" +
	"categories\x18\a \x03(\tR\n" +
	"categories\"\xd4\a\n" +
	"\x16AvailablePackageDetail\x12r\n" +
	"\x15available_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12P\n" +
	"\aversion\x18\x03 \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\aversion\x12\x19\n" +
	"\brepo_url\x18\x04 \x01(\tR\arepoUrl\x12\x19\n" +
	"\bhome_url\x18\x05 \x01(\tR\ahomeUrl\x12\x19\n" +
	...
	"\x10long_description\x18\t \x01(\tR\x0flongDescription\x12\x16\n" +
	"\x06readme\x18\n" +
	" \x01(\tR\x06readme\x12%\n" +
	"\x0edefault_values\x18\v \x01(\tR\rdefaultValues\x12\x94\x01\n" +
	"\x19additional_default_values\x18\x11 \x03(\v2X.kubeappsapis.core.packages.v1alpha1.AvailablePackageDetail.AdditionalDefaultValuesEntryR\x17additionalDefaultValues\x12#\n" +
	"\rvalues_schema\x18\f \x01(\tR\fvaluesSchema\x12\x1f\n" +
	"\vsource_urls\x18\r \x03(\tR\n" +
	"sourceUrls\x12Q\n" +
	"\vmaintainers\x18\x0e \x03(\v2/.kubeappsapis.core.packages.v1alpha1.MaintainerR\vmaintainers\x12\x1e\n" +
	"\n" +
	"categories\x18\x0f \x03(\tR\n" +
	"categories\x129\n" +
	"\rcustom_detail\x18\x10 \x01(\v2\x14.google.protobuf.AnyR\fcustomDetail\x1aJ\n" +
	"\x1cAdditionalDefaultValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x83\x06\n" +
	"\x17InstalledPackageSummary\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12i\n" +
	"\x15pkg_version_reference\x18\x03 \x01(\v25.kubeappsapis.core.packages.v1alpha1.VersionReferenceR\x13pkgVersionReference\x12_\n" +
	"\x0fcurrent_version\x18\x04 \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\x0ecurrentVersion\x12\x19\n" +
	"\bicon_url\x18\x05 \x01(\tR\aiconUrl\x12(\n" +
	"\x10pkg_display_name\x18\x06 \x01(\tR\x0epkgDisplayName\x12+\n" +
	"\x11short_description\x18\a \x01(\tR\x10shortDescription\x12n\n" +
	"\x17latest_matching_version\x18\b \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\x15latestMatchingVersion\x12]\n" +
	"\x0elatest_version\x18\t \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\rlatestVersion\x12S\n" +
	"\x06status\x18\n" +
	" \x01(\v2;.kubeappsapis.core.packages.v1alpha1.InstalledPackageStatusR\x06status\"\x91\b\n" +
	"\x16InstalledPackageDetail\x12r\n" +
	"\x15installed_package_ref\x18\x01 \x01(\v2>.kubeappsapis.core.packages.v1alpha1.InstalledPackageReferenceR\x13installedPackageRef\x12i\n" +
	"\x15pkg_version_reference\x18\x02 \x01(\v25.kubeappsapis.core.packages.v1alpha1.VersionReferenceR\x13pkgVersionReference\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12_\n" +
	"\x0fcurrent_version\x18\x04 \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\x0ecurrentVersion\x12%\n" +
	"\x0evalues_applied\x18\x05 \x01(\tR\rvaluesApplied\x12q\n" +
	"\x16reconciliation_options\x18\x06 \x01(\v2:.kubeappsapis.core.packages.v1alpha1.ReconciliationOptionsR\x15reconciliationOptions\x12S\n" +
	"\x06status\x18\a \x01(\v2;.kubeappsapis.core.packages.v1alpha1.InstalledPackageStatusR\x06status\x126\n" +
	"\x17post_installation_notes\x18\b \x01(\tR\x15postInstallationNotes\x12r\n" +
	"\x15available_package_ref\x18\t \x01(\v2>.kubeappsapis.core.packages.v1alpha1.AvailablePackageReferenceR\x13availablePackageRef\x12n\n" +
	"\x17latest_matching_version\x18\n" +
	" \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\x15latestMatchingVersion\x12]\n" +
	"\x0elatest_version\x18\v \x01(\v26.kubeappsapis.core.packages.v1alpha1.PackageAppVersionR\rlatestVersion\x129\n" +
	"\rcustom_detail\x18\x0e \x01(\v2\x14.google.protobuf.AnyR\fcustomDetail\"A\n" +
	"\aContext\x12\x18\n" +
	"\acluster\x18\x01 \x01(\tR\acluster\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\"\xc7\x01\n" +
	"\x19AvailablePackageReference\x12F\n" +
	"\acontext\x18\x01 \x01(\v2,.kubeappsapis.core.packages.v1alpha1.ContextR\acontext\x12\x1e\n" +
	"\n" +
	"identifier\x18\x02 \x01(\tR\n" +
	"identifier\x12B\n" +
	"\x06plugin\x18\x03 \x01(\v2*.kubeappsapis.core.plugins.v1alpha1.PluginR\x06plugin\"6\n" +
	"\n" +
	"Maintainer\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\"\xab\x01\n" +
	"\rFilterOptions\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\x12\x1e\n" +
	"\n" +
	"categories\x18\x02 \x03(\tR\n" +
	"categories\x12\"\n" +
	"\frepositories\x18\x03 \x03(\tR\frepositories\x12\x1f\n" +
	"\vpkg_version\x18\x04 \x01(\tR\n" +
	"pkgVersion\x12\x1f\n" +
	...
	"\tpage_size\x18\x02 \x01(\x05R\bpageSize\"\xc7\x01\n" +
	"\x19InstalledPackageReference\x12F\n" +
	"\acontext\x18\x01 \x01(\v2,.kubeappsapis.core.packages.v1alpha1.ContextR\acontext\x12\x1e\n" +
	"\n" +
	"identifier\x18\x02 \x01(\tR\n" +
	"identifier\x12B\n" +
	"\x06plugin\x18\x03 \x01(\v2*.kubeappsapis.core.plugins.v1alpha1.PluginR\x06plugin\",\n" +
	"\x10VersionReference\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\"\xd2\x02\n" +
	"\x16InstalledPackageStatus\x12\x14\n" +
	"\x05ready\x18\x01 \x01(\bR\x05ready\x12`\n" +
	"\x06reason\x18\x02 \x01(\x0e2H.kubeappsapis.core.packages.v1alpha1.InstalledPackageStatus.StatusReasonR\x06reason\x12\x1f\n" +
	"\vuser_reason\x18\x03 \x01(\tR\n" +
	"userReason\"\x9e\x01\n" +
	"\fStatusReason\x12\x1d\n" +
	"\x19STATUS_REASON_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17STATUS_REASON_INSTALLED\x10\x01\x12\x1d\n" +
	"\x19STATUS_REASON_UNINSTALLED\x10\x02\x12\x18\n" +
	"\x14STATUS_REASON_FAILED\x10\x03\x12\x19\n" +
	"\x15STATUS_REASON_PENDING\x10\x04\"\x7f\n" +
	"\x15ReconciliationOptions\x12\x1a\n" +
	"\binterval\x18\x01 \x01(\tR\binterval\x12\x18\n" +
	"\asuspend\x18\x02 \x01(\bR\asuspend\x120\n" +
	"\x14service_account_name\x18\x03 \x01(\tR\x12serviceAccountName\"U\n" +
	"\x11PackageAppVersion\x12\x1f\n" +
	"\vpkg_version\x18\x01 \x01(\tR\n" +
	"pkgVersion\x12\x1f\n" +
	"\vapp_version\x18\x02 \x01(\tR\n" +
	"appVersion\"\xb5\x01\n" +
	"\x0fPackageMetadata\x12\x1d\n" +
	"\n" +
	...
	"\tnamespace\x18\x04 \x01(\tR\tnamespace2\xc0\x1d\n" +
	"\x0fPackagesService\x12\xe6\x01\n" +
	"\x1cGetAvailablePackageSummaries\x12H.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageSummariesRequest\x1aI.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageSummariesResponse\"1\x82\xd3\xe4\x93\x02+\x12)/core/packages/v1alpha1/availablepackages\x12\xaf\x03\n" +
	"\x19GetAvailablePackageDetail\x12E.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageDetailRequest\x1aF.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageDetailResponse\"\x82\x02\x82\xd3\xe4\x93\x02\xfb\x01\x12\xf8\x01/core/packages/v1alpha1/availablepackages/plugin/{available_package_ref.plugin.name}/{available_package_ref.plugin.version}/c/{available_package_ref.context.cluster}/ns/{available_package_ref.context.namespace}/{available_package_ref.identifier=**}\x12\xbe\x03\n" +
	"\x1bGetAvailablePackageVersions\x12G.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageVersionsRequest\x1aH.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageVersionsResponse\"\x8b\x02\x82\xd3\xe4\x93\x02\x84\x02\x12\x81\x02/core/packages/v1alpha1/availablepackages/plugin/{available_package_ref.plugin.name}/{available_package_ref.plugin.version}/c/{available_package_ref.context.cluster}/ns/{available_package_ref.context.namespace}/{available_package_ref.identifier=**}/versions\x12\xc1\x03\n" +
	"\x1cGetAvailablePackageMetadatas\x12H.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageMetadatasRequest\x1aI.kubeappsapis.core.packages.v1alpha1.GetAvailablePackageMetadatasResponse\"\x8b\x02\x82\xd3\xe4\x93\x02\x84\x02\x12\x81\x02/core/packages/v1alpha1/availablepackages/plugin/{available_package_ref.plugin.name}/{available_package_ref.plugin.version}/c/{available_package_ref.context.cluster}/ns/{available_package_ref.context.namespace}/{available_package_ref.identifier=**}/metadata\x12\xe6\x01\n" +
	"\x1cGetInstalledPackageSummaries\x12H.kubeappsapis.core.packages.v1alpha1.GetInstalledPackageSummariesRequest\x1aI.kubeappsapis.core.packages.v1alpha1.GetInstalledPackageSummariesResponse\"1\x82\xd3\xe4\x93\x02+\x12)/core/packages/v1alpha1/installedpackages\x12\xac\x03\n" +
	"\x19GetInstalledPackageDetail\x12E.kubeappsapis.core.packages.v1alpha1.GetInstalledPackageDetailRequest\x1aF.kubeappsapis.core.packages.v1alpha1.GetInstalledPackageDetailResponse\"\xff\x01\x82\xd3\xe4\x93\x02\xf8\x01\x12\xf5\x01/core/packages/v1alpha1/installedpackages/plugin/{installed_package_ref.plugin.name}/{installed_package_ref.plugin.version}/c/{installed_package_ref.context.cluster}/ns/{installed_package_ref.context.namespace}/{installed_package_ref.identifier}\x12\xd7\x01\n" +
	"\x16CreateInstalledPackage\x12B.kubeappsapis.core.packages.v1alpha1.CreateInstalledPackageRequest\x1aC.kubeappsapis.core.packages.v1alpha1.CreateInstalledPackageResponse\"4\x82\xd3\xe4\x93\x02.:\x01*\")/core/packages/v1alpha1/installedpackages\x12\xa6\x03\n" +
	"\x16UpdateInstalledPackage\x12B.kubeappsapis.core.packages.v1alpha1.UpdateInstalledPackageRequest\x1aC.kubeappsapis.core.packages.v1alpha1.UpdateInstalledPackageResponse\"\x82\x02\x82\xd3\xe4\x93\x02\xfb\x01:\x01*\x1a\xf5\x01/core/packages/v1alpha1/installedpackages/plugin/{installed_package_ref.plugin.name}/{installed_package_ref.plugin.version}/c/{installed_package_ref.context.cluster}/ns/{installed_package_ref.context.namespace}/{installed_package_ref.identifier}\x12\xa3\x03\n" +
	"\x16DeleteInstalledPackage\x12B.kubeappsapis.core.packages.v1alpha1.DeleteInstalledPackageRequest\x1aC.kubeappsapis.core.packages.v1alpha1.DeleteInstalledPackageResponse\"\xff\x01\x82\xd3\xe4\x93\x02\xf8\x01*\xf5\x01/core/packages/v1alpha1/installedpackages/plugin/{installed_package_ref.plugin.name}/{installed_package_ref.plugin.version}/c/{installed_package_ref.context.cluster}/ns/{installed_package_ref.context.namespace}/{installed_package_ref.identifier}\x12\xcb\x03\n" +
	"\x1fGetInstalledPackageResourceRefs\x12K.kubeappsapis.core.packages.v1alpha1.GetInstalledPackageResourceRefsRequest\x1aL.kubeappsapis.core.packages.v1alpha1.GetInstalledPackageResourceRefsResponse\"\x8c\x02\x82\xd3\xe4\x93\x02\x85\x02\x12\x82\x02/core/packages/v1alpha1/installedpackages/plugin/{installed_package_ref.plugin.name}/{installed_package_ref.plugin.version}/c/{installed_package_ref.context.cluster}/ns/{installed_package_ref.context.namespace}/{installed_package_ref.identifier}/resourcerefsBOZMgithub.com/vmware-tanzu/kubeapps/cmd/kubeapps-apis/gen/core/packages/v1alpha1b\x06proto3"

var (
	file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDescOnce sync.Once
	file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDescData []byte
)
...
func file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDescGZIP() []byte {
	file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDescOnce.Do(func() {
		file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDesc), len(file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDesc)))
	})
...
func file_kubeappsapis_core_packages_v1alpha1_packages_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDesc), len(file_kubeappsapis_core_packages_v1alpha1_packages_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   37,
			NumExtensions: 0,
			NumServices:   1,
