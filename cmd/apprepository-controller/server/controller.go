...
import (
	...
	clientset "github.com/SAP/kubeapps/cmd/apprepository-controller/pkg/client/clientset/versioned"
	appreposcheme "github.com/SAP/kubeapps/cmd/apprepository-controller/pkg/client/clientset/versioned/scheme"
	informers "github.com/SAP/kubeapps/cmd/apprepository-controller/pkg/client/informers/externalversions"
	listers "github.com/SAP/kubeapps/cmd/apprepository-controller/pkg/client/listers/apprepository/v1alpha1"
...
func (c *Controller) handleAppRepoOwnedObject(obj interface{}) {
	...
	if ownerRef := metav1.GetControllerOf(object); ownerRef != nil {
		...
		if apprepo.DeletionTimestamp != nil {
			apprepoKey := fmt.Sprintf("%s/%s", apprepo.GetNamespace(), apprepo.GetName())
			log.Infof("Ignoring AppRepository %q, it was already marked for deletion at timestamp %q", apprepoKey, apprepo.DeletionTimestamp)
			return
		}
